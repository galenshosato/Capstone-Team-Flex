...
const income = [
  { id: 1, name: "Bartending", amount: "500.00" },
  { id: 2, name: "Security", amount: "1000.00" },
];

const expenses = [
  { id: 1, name: "Car note", amount: "500.00" },
  { id: 2, name: "Day care", amount: "500.00" },
  { id: 3, name: "Pet supplies", amount: "500.00" },
];
